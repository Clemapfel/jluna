...
function Base.lock(mutex::Mutex)
    ...
    @lock _mutex_lock_lock ccall((:lock_mutex, jluna._cppcall._library_name), Cvoid, (Csize_t,), mutex._native_handle)
...
function Base.unlock(mutex::Mutex)
    ...
    @lock _mutex_lock_lock ccall((:unlock_mutex, jluna._cppcall._library_name), Cvoid, (Csize_t,), mutex._native_handle)
